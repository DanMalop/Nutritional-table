nutrition_info_model = {'Calories': {'amount': 0, 'unit': 'kcal', 'percentOfDailyNeeds': 0},
                        'Fat': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0},
                        'Poly Unsaturated Fat': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0},
                        'Saturated Fat': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0}, 
                        'Trans fat': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0},                        
                        ...
                        "Added sugar": {"amount": 0,"unit": "g","percentOfDailyNeeds": 0},
                        'Protein': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0},
                        'Sodium': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0},
                        'Copper': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Mono Unsaturated Fat': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0}, 
                        'Zinc': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Iron': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin B2': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin A': {'amount': 0, 'unit': 'IU', 'percentOfDailyNeeds': 0}, 
                        'Net Carbohydrates': {'amount': 0, 'unit': 'g', 'percentOfDailyNeeds': 0}, 
                        'Magnesium': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin B6': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Phosphorus': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin B1': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin B2': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin B3': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Manganese': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Calcium': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin D': {'amount': 0, 'unit': 'µg', 'percentOfDailyNeeds': 0.0}, 
                        'Potassium': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Cholesterol': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin B12': {'amount': 0, 'unit': 'µg', 'percentOfDailyNeeds': 0}, 
                        'Vitamin C': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0},
                        'Alcohol': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0},
                        'Vitamin K': {'amount': 0, 'unit': 'mg', 'percentOfDailyNeeds': 0}}

ingredient_codes_list = {
